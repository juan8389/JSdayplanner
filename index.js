...
function hourFour() {
    var textareaInput10 = document.querySelector("#comment5pm")
    var divOutput9 = document.querySelector("#comment5pm")
    var saveButton9 = document.querySelector("#button5pm")
...
divOutput9.textContent = localStorage.getItem("content9");
textareaInput10.textContent = localStorage.getItem("content9");
outputUpdate9()
function outputUpdate9() {
    localStorage.setItem("content9", textareaInput10.value);

    divOutput9.textContent = textareaInput10.value
}
}